      ...
      <div className="bg-indigo-600 text-white">
        <div className="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <div className="mt-10">
              <Link href="/employer/post-job" className="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-indigo-600 bg-white hover:bg-gray-50">
                Post a Job
              </Link>
            </div>
          </div>
              ...
              {features.map((feature) => (
                <div key={feature.title} className="relative">
                  ...
                  <div className="ml-16">
                    ...
                    <div className="mt-4">
                      <Link href={feature.link} className="text-indigo-600 hover:text-indigo-500">
                        Learn more →
                      </Link>
                    </div>
                  </div>
      ...
      <div className="bg-white">
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between">
          <h2 className="text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">
            ...
            <span className="block text-indigo-600">Create your employer account today.</span>
          </h2>
